...
PALETTE={0 21 22 23 24 25 26 8 9 10 11 12 13 14 15 16}
...
$(eval $(call IMG2SPRITES,assets/pixels.png,0,g,4,4,$(PALETTE),tileset,src/sprites/,hwpalette))
$(eval $(call IMG2SPRITES,assets/lredimborde3.png,0,titulo,120,60,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/protile3.png,0,sprite,8,15,$(PALETTE),tileset,src/sprites/,))
$(eval $(call IMG2SPRITES,assets/torreta3.png,0,stor,4,12,$(PALETTE),tileset,src/sprites,))
$(eval $(call IMG2SPRITES,assets/bala3.png,0,sbala,2,4,$(PALETTE),tileset,src/sprites,))
$(eval $(call IMG2SPRITES,assets/heart2.png,0,sheart,8,8,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/coronasola.png,0,scrown,6,4,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/fin2.png,0,sfin,120,100,$(PALETTE),,src/sprites,))